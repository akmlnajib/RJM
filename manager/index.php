...
<body class="sb-nav-fixed">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (suggestions.length > 0) {
                            ...
                            selectedIdAlternatif = firstSuggestion.id_karyawan;

                            $("#namanama").val(firstSuggestion.nama_karyawan);
                            $("input[name='id_karyawan']").val(selectedIdAlternatif);
                        } else {
                            selectedNik = null;
    ...
    <script>
        ...
        const data = {
            ...
            datasets: [{
                label: '',
                data: <?php echo json_encode($jumlah_karyawan); ?>,
                backgroundColor: [
                    'rgba(255, 99, 132)',
                    'rgba(255, 159, 64)',
                    'rgba(255, 205, 86)',
